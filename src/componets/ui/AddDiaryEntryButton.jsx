...
export const AddDiaryEntryButton = ({ openDialog, entry }) => {
  return (
    <button
      onClick={openDialog}
      className="group cursor-pointer w-full text-lg mt-3 sm:m-0 sm:w-auto bg-gradient-to-r from-blue-500 to-purple-600 px-6 py-3 rounded-xl text-white shadow-lg transition-all duration-300 hover:shadow-purple-200 hover:scale-105 active:scale-95 flex items-center justify-center gap-2"
    >
